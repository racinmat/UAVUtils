...
class benchmark {
	...
	private static function test_Math($count = 1400000) {
	...
	private static function test_StringManipulation($count = 1300000) {
		$time_start = microtime(true);
//		$stringFunctions = array("addslashes", "chunk_split", "metaphone", "strip_tags", "md5", "sha1", "strtoupper", "strtolower", "strrev", "strlen", "soundex", "ord");
		$stringFunctions = array("addslashes", "strip_tags", "md5", "sha1", "strtoupper", "strtolower", "strrev", "strlen", "ord");
